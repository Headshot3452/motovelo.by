<?php
    class m160429_135036_cart_orders extends CDbMigration
    {
        public function up()
        {
            ...
            $this->createIndex('order_id_idx', 'payment', 'order_id');
            $this->addForeignKey("fk_payment_orders_order_id", "payment", "order_id", "orders", "id", "CASCADE", "CASCADE");
        }
        ...
        public function down()
        {
            ...
            $this->dropForeignKey('fk_payment_orders_order_id', 'payment');
        }
    }