<div class="form top-filter">
    ...
    <div class="col-xs-2 buttons-block">
        <?php
            echo BsHtml::submitButton('',array('icon'=>BsHtml::GLYPHICON_SEARCH,'title'=>'Фильтр', 'data-toggle'=>'tooltip'));
            echo BsHtml::submitButton('<span class="fa fa-level-up fa-rotate-270"></span>',array('class'=>'reset pull-right hidden','title'=>'Сбросить фильтр', 'data-toggle'=>'tooltip'));
        ?>
    </div>
    </div>
